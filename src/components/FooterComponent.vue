  ...
  <div>
    <section class="md:flex md:flex-row">
      <section class="flex flex-column bg-black pt-8 md:w-1/3">
        ...
        <article class="w-1/2 md:w-1/2">
          <img src='../assets/Pictures/articho-logo.png' alt="Logo du site" class="md:w-1/3 ml-12 md:ml-20 w-1/2">
          <br />
        </article>
      </section>
      ...
      <section class="flex flex-column bg-black md:w-1/3">
        <article class="w-2/5 md:w-1/2">
          ...
          <ul class="ml-2 pl-2 md:ml-20">
            <li class="text-white"><a href="/"><p class="text-left hover:underline"> {{ this.lang_fr ?"Accueil" : "Home" }}</p></a></li>
            <li class="text-white"><a href="/Reservation"><p class="text-left hover:underline"> {{ this.lang_fr ? "Réservation" : "Booking" }}</p></a></li>
            <li class="text-white"><a href="/WhoAreWe"><p class="text-left hover:underline">{{ this.lang_fr ? "Qui Sommes Nous" : "About us" }}</p></a></li>
        ...
        <article class="w-3/5 md:w-1/2">
          ...
          <ul class="ml-2 pl-2 md:ml-4">
            ...
            <li class="text-white"><p class="text-left">Mail : hotel.artichaud@gmail.com</p></li>
            <li class="text-white"><p class="text-left">Adresse : Chemin au milieu des arbres 30200 La Grande Vallée</p></li>
          </ul>
          <br />
        </article>
      </section>
